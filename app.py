...
def listar_reglas_balance(
    ...
    for leaf_id, path in paths.items():
        ...
        w, probs, samples = _node_counts_and_probvec(tree_, leaf_id)
        if samples <= 0 or probs.size == 0:
            continue
...
with col1:
    ...
    # USAR SIEMPRE los valores aplicados (NO los inputs)
